...
export const MatchoryFilters = ({
  ...
  return (
    <div className="matchory-search-container block w-[312px] bg-[#FFFFFF]">
      <div className="title-section flex justify-between p-[12px] h-[56px] text-[16px] font-[700] border-b-[1px] border-gray-200">
      ...
      {data.map((section, id) => (
        <div
          className="keyword-section items-center gap-[12px] p-[12px] border-b-[1px] border-gray-200"
          key={id}
        >
